...
async function testSessionCreation() {
  ...
  try {
    ...
    console.log('❌ Test 1: Creating session without session_id (should fail)...');
    ...
    try {
      ...
      console.log('✅ PASS: Validation correctly failed for missing session_id');
    ...
    console.log('✅ PASS: Schema validation passed (uniqueness checked on save)');
    console.log('   Note: Uniqueness constraint is enforced at database level\n');
    ...
    console.log('   4. Use session.session_id (not session._id) for communication');
