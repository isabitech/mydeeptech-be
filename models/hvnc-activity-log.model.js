        ...
        ip_address: {
            ...
            validate: {
                validator: function(v) {
                    ...
                    // Allow IPv4, IPv6, and localhost formats
...
hvncActivityLogSchema.index({ timestamp: 1 }, { expireAfterSeconds: 60 * 24 * 60 * 60 }); // 60 days TTL

// Static methods for logging different types of events
hvncActivityLogSchema.statics.logDeviceEvent = function(deviceId, eventType, eventData, options = {}) {
    return this.create({
        device_id: deviceId,
...
hvncActivityLogSchema.statics.logUserEvent = function(userEmail, eventType, eventData, options = {}) {
    return this.create({
...
hvncActivityLogSchema.statics.logSessionEvent = function(sessionId, eventType, eventData, options = {}) {
    return this.create({
...
hvncActivityLogSchema.statics.logSecurityEvent = function(eventType, eventData, options = {}) {
    return this.create({
        event_type: eventType,
        event_data: eventData,
...
hvncActivityLogSchema.statics.logCommandEvent = function(commandId, eventType, eventData, options = {}) {
    return this.create({
        event_type: eventType,
        event_data: eventData,
        severity: options.severity || 'low',
...
hvncActivityLogSchema.statics.getRecentEvents = function(limit = 100, eventTypes = null) {
    const query = {};
...
hvncActivityLogSchema.statics.getEventsByUser = function(userEmail, startDate, endDate, limit = 100) {
    const query = {
        user_email: userEmail.toLowerCase()
    };
...
hvncActivityLogSchema.statics.getEventsByDevice = function(deviceId, startDate, endDate, limit = 100) {
    const query = {
        device_id: deviceId
    };
...
hvncActivityLogSchema.statics.getSecurityEvents = function(startDate, endDate, limit = 100) {
    const query = {
        $or: [
            { is_flagged: true },
...
hvncActivityLogSchema.statics.getEventStatistics = function(startDate, endDate) {
    const matchStage = {};
...
hvncActivityLogSchema.statics.flagEvent = function(eventId, reviewedBy, notes) {
