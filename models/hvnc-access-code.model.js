...
hvncAccessCodeSchema.virtual("is_valid").get(function () {
  return this.is_active && !this.is_expired && this.used_count < this.max_uses;
});
...
hvncAccessCodeSchema.methods.validateCode = function (inputCode) {
  ...
  return (
    bcrypt.compareSync(inputCode, this.code_hash) ||
...
hvncAccessCodeSchema.methods.deactivate = function (
...
hvncAccessCodeSchema.statics.createForUser = async function (
  userEmail,
  deviceId,
  ipAddress,
  expiresInHours = 24,
...
hvncAccessCodeSchema.statics.findValidCode = function (
  code,
  deviceId,
  userEmail,
) {
...
hvncAccessCodeSchema.statics.invalidateUserCodes = function (
  userEmail,
  deviceId,
) {
