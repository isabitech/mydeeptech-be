...
router.get("/permission/all/name", authenticateToken, authenticateAdmin, PermissionController.getAllPermissionsByName);
router.get("/permission/all/name/:name", authenticateToken, authenticateAdmin, PermissionController.getAllPermissionsByName);
